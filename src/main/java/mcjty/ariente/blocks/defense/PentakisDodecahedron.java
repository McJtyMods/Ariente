...
public class PentakisDodecahedron {
    ...
    static {
        ...
        VERTICES[0] = new Vec3d(0.0, c0, c3).scale(1.0f/c3);
        VERTICES[1] = new Vec3d(0.0, c0, -c3).scale(1.0f/c3);
        VERTICES[2] = new Vec3d(0.0, -c0, c3).scale(1.0f/c3);
        VERTICES[3] = new Vec3d(0.0, -c0, -c3).scale(1.0f/c3);
        VERTICES[4] = new Vec3d(c3, 0.0, c0).scale(1.0f/c3);
        VERTICES[5] = new Vec3d(c3, 0.0, -c0).scale(1.0f/c3);
        VERTICES[6] = new Vec3d(-c3, 0.0, c0).scale(1.0f/c3);
        VERTICES[7] = new Vec3d(-c3, 0.0, -c0).scale(1.0f/c3);
        VERTICES[8] = new Vec3d(c0, c3, 0.0).scale(1.0f/c3);
        VERTICES[9] = new Vec3d(c0, -c3, 0.0).scale(1.0f/c3);
        VERTICES[10] = new Vec3d(-c0, c3, 0.0).scale(1.0f/c3);
        VERTICES[11] = new Vec3d(-c0, -c3, 0.0).scale(1.0f/c3);
        VERTICES[12] = new Vec3d(c1, 0.0, c2).scale(1.0f/c3);
        VERTICES[13] = new Vec3d(c1, 0.0, -c2).scale(1.0f/c3);
        VERTICES[14] = new Vec3d(-c1, 0.0, c2).scale(1.0f/c3);
        VERTICES[15] = new Vec3d(-c1, 0.0, -c2).scale(1.0f/c3);
        VERTICES[16] = new Vec3d(c2, c1, 0.0).scale(1.0f/c3);
        VERTICES[17] = new Vec3d(c2, -c1, 0.0).scale(1.0f/c3);
        VERTICES[18] = new Vec3d(-c2, c1, 0.0).scale(1.0f/c3);
        VERTICES[19] = new Vec3d(-c2, -c1, 0.0).scale(1.0f/c3);
        VERTICES[20] = new Vec3d(0.0, c2, c1).scale(1.0f/c3);
        VERTICES[21] = new Vec3d(0.0, c2, -c1).scale(1.0f/c3);
        VERTICES[22] = new Vec3d(0.0, -c2, c1).scale(1.0f/c3);
        VERTICES[23] = new Vec3d(0.0, -c2, -c1).scale(1.0f/c3);
        VERTICES[24] = new Vec3d(1.5, 1.5, 1.5).scale(1.0f/c3);
        VERTICES[25] = new Vec3d(1.5, 1.5, -1.5).scale(1.0f/c3);
        VERTICES[26] = new Vec3d(1.5, -1.5, 1.5).scale(1.0f/c3);
        VERTICES[27] = new Vec3d(1.5, -1.5, -1.5).scale(1.0f/c3);
        VERTICES[28] = new Vec3d(-1.5, 1.5, 1.5).scale(1.0f/c3);
        VERTICES[29] = new Vec3d(-1.5, 1.5, -1.5).scale(1.0f/c3);
        VERTICES[30] = new Vec3d(-1.5, -1.5, 1.5).scale(1.0f/c3);
        VERTICES[31] = new Vec3d(-1.5, -1.5, -1.5).scale(1.0f/c3);
