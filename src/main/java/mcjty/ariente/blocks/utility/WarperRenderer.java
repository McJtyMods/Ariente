...
public class WarperRenderer extends TileEntitySpecialRenderer<WarperTile> {
    ...
    @Override
    public void render(WarperTile te, double x, double y, double z, float time, int breakTime, float alpha) {
//        if (te.isWorking()) {
