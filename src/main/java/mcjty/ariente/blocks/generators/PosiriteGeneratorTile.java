...
//        }
    ...
    public IGuiComponent createGui(String tag) {
        return new HoloPanel(0, 0, 8, 8)
                .add(new HoloText(0, 0, 8, 1,"Posirite", 0xaaccff))
                .add(new HoloItemStack(0, 3, 1, 1, new ItemStack(ModItems.posiriteDust)))

                .add(new HoloIcon(1, 3, 1, 1).image(128+64, 128))
                .add(new HoloNumber(2, 3, 1, 1, 0xffffff, (p,h) -> HoloGuiTools.countItem(p, ModItems.posiriteDust)))
                ...
                .add(new HoloItemStack(5, 3, 1, 1, new ItemStack(ModBlocks.posiriteGeneratorBlock)))
                .add(new HoloNumber(6, 3, 1, 1,0xffffff, this::countPosiriteGenerator))
    ...
    public Integer countPosiriteGenerator(EntityPlayer player, HoloGuiEntity holo) {
