...
public class FluxLevitatorModel extends ModelBase {
    ...
    public FluxLevitatorModel() {
        ...
        this.sideModelsS1.addBox(6.0F, -14.5F, -1.0F, 2, 8, 2, 0.0F);
        ...
        this.sideModelsS2.addBox(-8.0F, -14.5F, -1.0F, 2, 8, 2, 0.0F);
        ...
        this.sideModelsS3.addBox(6.0F, -14.5F, -1.0F, 2, 8, 2, 0.0F);
        ...
        this.sideModels4.addBox(-14.0F, -7.0F, -1.0F, 28, 6, 2, 0.0F);
        ...
        this.sideModels2.addBox(-8.0F, -7.0F, -1.0F, 16, 7, 2, 0.0F);
        ...
        this.sideModelsS4.addBox(-8.0F, -14.5F, -1.0F, 2, 8, 2, 0.0F);
        ...
        this.sideModels5.addBox(-14.0F, -7.0F, -1.0F, 28, 6, 2, 0.0F);
        this.sideModels3 = new ModelRenderer(this, 0, 0);
        this.sideModels3.setRotationPoint(15.0F, 4.0F, 0.0F);
        this.sideModels3.addBox(-8.0F, -7.0F, -1.0F, 16, 7, 2, 0.0F);
        ...
        this.sideModelsT.addBox(-14.0F, -8.0F, 10.0F, 28, 16, 2, 0.0F);
