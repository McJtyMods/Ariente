...
import mcjty.ariente.entities.levitator.FluxLevitatorModel;
...
//        }
    ...
    protected void renderCartContents(FluxShipEntity p_188319_1_, float partialTicks, IBlockState p_188319_3_) {
        GlStateManager.pushMatrix();
